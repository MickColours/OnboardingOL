...
<html>
  <head>
    <title>Subject Metrics | AFMS Online Onboarding Learning Resource</title>
  ...
  <body>
	...
	$query_string = "call Asrcoo.descriptive_stats_subject(:sid);";

	$sth = $dbh->prepare($query_string);
	$sth->bindParam(':sid',$subject_id, PDO::PARAM_INT);
        $sth->execute();
...
?>
	<div class="container">
	<h1 id="tableHeading">Metrics for Subject: <?php echo $subject_name ?></h1>
