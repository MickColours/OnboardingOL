...
<html>
  <head>
    <title>User Metrics | AFMS Online Onboarding Learning Resource</title>
  ...
  <body>
	...
	$query_string = "call Asrcoo.descriptive_stats_user(:uid);";
...
?>
	<div class="container">
	<h1 id="tableHeading">Metrics for user: <?php echo $user_name ?></h1>
